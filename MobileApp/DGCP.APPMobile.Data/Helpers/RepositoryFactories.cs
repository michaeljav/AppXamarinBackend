...
namespace DGCP.APPMobile.Data.Helpers
{
    public class RepositoryFactories
    {
        ...
        /// </summary>
        /// <remarks>
        /// MODIFY THIS METHOD TO ADD CUSTOM MONLINE FACTORY FUNCTIONS
        /// </remarks>
        private IDictionary<Type, Func<DbContext, object>> GetMOnlineFactories()
        {
        ...
        {
            _repositoryFactories = GetMOnlineFactories();
        }
